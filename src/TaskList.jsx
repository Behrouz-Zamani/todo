                ...
                <ul className='list-group M-0 P-0 MT-2'>
                    {
                        taskItem.map(t=>(
                            ...
                            <span>
                                {
                                    t.done ? ( <i className='me-3 poimer fas fa-check text-success transition_200 text_hover_shadow'></i>) : (<i className='me-3 poimer fas fa-times text-warning transition_200 text_hover_shadow'></i>)
                                }
